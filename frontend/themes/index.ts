...
export const themes: ThemeMetadata[] = [lightTheme, vscodeLightTheme, darkTheme, vscodeDarkTheme, matrixTheme, metalTheme, barbieTheme, falloutTheme, synthTokyoTheme, alohaTheme];
