...
test("barbie theme screenshot", async ({ page }) => {
  ...
  await page.evaluate(() => { document.documentElement.dataset.theme = "barbie"; });
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${SCREENSHOTS_DIR}/barbie-dashboard.png`, fullPage: true });
});
