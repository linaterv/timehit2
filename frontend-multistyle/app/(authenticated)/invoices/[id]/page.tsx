...
export default function InvoiceDetailPage() {
  ...
  return (
    <div data-testid="invoice-detail" className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <StatusBadge value={invoice.invoice_type} />
            <StatusBadge value={invoice.status} />
          </div>
          <p className="text-sm text-gray-500">
            {invoice.client.company_name} &mdash;{" "}
            {invoice.contractor.full_name} &mdash;{" "}
            {formatMonth(invoice.year, invoice.month)}
          </p>
        </div>
      ...
      {/* Details Card */}
      <div className="border rounded-lg p-6 space-y-3 bg-surface">
